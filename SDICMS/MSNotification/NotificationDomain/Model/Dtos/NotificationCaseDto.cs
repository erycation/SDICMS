...
{
    public class NotificationCaseDto
    {
        ...
        public string? ChildNameAbbr
        {
            get
            {
                return !String.IsNullOrEmpty(ChildName) ? ChildName.Substring(0, 1).ToUpper() : "";
            }
        }
        public string? NotificationDateSet
        {
            get
            {
                return NotificationDate != null ?
                    NotificationDate?.ToString("yyyy MMM dd") : null;
            }
        }
        public string? ArrestDateFormat
        {
            get
            {
                return ArrestDate != null ?
                    ArrestDate?.ToString("yyyy MMM dd") : null;
            }
        }
    }
}