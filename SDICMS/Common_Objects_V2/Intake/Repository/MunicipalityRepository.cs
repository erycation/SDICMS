...
{
    public class MunicipalityRepository : IntakeRepository<Municipality>, IMunicipalityRepository
    {

        public MunicipalityRepository(IntakeDBContext intakeDBContext) : base(intakeDBContext)
        {
